  ...
  <div class="main-container">
        ...
        <div class="nav-upper-options">
          ...
          <div class="option2 nav-option">
            <img src="https://media.geeksforgeeks.org/wp-content/uploads/20221210183322/9.png" class="nav-img"
              alt="articles">
            <a class="nav-link active" href="#Manageroutes">Stops</a>
          </div>
          ...
          <div class="nav-option option4">
            <img src="https://media.geeksforgeeks.org/wp-content/uploads/20221210183321/6.png" class="nav-img"
              alt="institution">
              <a href="add-point.php">Add New points </a>
          ...
          <div class="nav-option option5">
            <img src="https://media.geeksforgeeks.org/wp-content/uploads/20221210183323/10.png" class="nav-img"
              alt="blog">
            <a class="nav-link" href="#bookings">Manage Resevations</a>
          </div>
    ...
    <div class="main">
      ...
      <div class="box-container">
        ...
        <div class="box box1">
          <div class="text">
            <h6 class="topic-heading">Register Passenger</h6>
            <h2 class="topic">Registration form</h2>
          </div>
        ...
        <div class="box box4">
          <div class="text">
            ...
            <h2 class="topic">Active Buses</h2>
          </div>
      ...
      <div class="report-container " id="Manageroutes">
        <div class="report-header">
          ...
          <h1 class="recent-Articles">Active Buses</h1>
          <!-- <button class="view" style=" height: 45px; "><a href="add-point.php">Add New Bus </a></button> -->
        ...
        <div class="report-body">
          <div class="report-topic-heading">
            <h3 class="t-op">Route Name</h3>
            <h3 class="t-op">Hour</h3>
            <h3 class="t-op" style="margin-right: 30px;">Expected Arrival</h3>
            <h3 class="t-op" style="margin-right: 30px;">Plate Numbers</h3>
            <h3 class="t-op" style="margin-right: 30px;">Total Passengers</h3>
            <h3 class="t-op">Actions</h3>
          </div>

          <div class="items">
            <div class="item1">
              <h3 class="t-op-nextlvl">Zayed/October</h3>
              <h3 class="t-op-nextlvl">8:00am</h3>
              <h3 class="t-op-nextlvl">9:00am</h3>
              <h3 class="t-op-nextlvl">7352 F K</h3>
              <h3 class="t-op-nextlvl">7p</h3>
            ...
            <div class="item1">
              <h3 class="t-op-nextlvl">Maadi</h3>
              <h3 class="t-op-nextlvl">8:00am</h3>
              <h3 class="t-op-nextlvl">9:00am</h3>
              <h3 class="t-op-nextlvl">2533 F K</h3>
              <h3 class="t-op-nextlvl">5p</h3>
              <div class="card" style="
                            left: 8px;
                            height: 52px;
                            width: 82px;
      ...
      <div class="report-container" id="buses">
        <div class="report-header">
          <h1 class="recent-Articles">Bus Settings</h1>
        ...
        <div class="report-body">
          <div class="report-topic-heading">
            ...
            <h3 class="t-op">Plate Numbers</h3>
          ...
          <div class="items">
            <div class="item1">
              <h3 class="t-op-nextlvl">9837</h3>
              <h3 class="t-op-nextlvl">12</h3>
              <h3 class="t-op-nextlvl">7352 F K</h3>
              <h3 class="t-op-nextlvl">Mohamed Ghaly</h3>
            ...
            <div class="item1">
              <h3 class="t-op-nextlvl">7253</h3>
              <h3 class="t-op-nextlvl">12</h3>
              <h3 class="t-op-nextlvl">2533 F K</h3>
              <h3 class="t-op-nextlvl">Karim ElSaed</h3>
              <h3 class="t-op-nextlvl">Coaster</h3>
              <div class="card" style="
                            left: 8px;
                            height: 52px;
