                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="text-center">
                            ...
                            <form id="busForm" action="phpedit_type.php" class="form" method="get">
                                <?php
                                require_once('connection.php');
                                $id = $_GET['name'];
                                $stmt = $conn->prepare("SELECT * FROM type WHERE name = ?");
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="name" name="name" value="<?= $row['name'] ?>"
                                            placeholder="Enter Bus Type" class="form-control" type="text" required>
                                    </div>
                                    <!--<div class="input-group mb-3">
                                        <span class="input-group-addon"><i
                                                class="glyphicon glyphicon-envelope color-blue"></i></span>
