                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="text-center">
                            ...
                            <form id="busForm" action="edit_driver.php" class="form" method="get">
                                <?php
                                require_once('connection.php');
                                $id = $_GET['id'];
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="busID" name="Name" value="<?= $row['name'] ?>"
                                            placeholder="Enter Bus Name" class="form-control" type="text" required>
                                    </div>
                                    <div class="input-group mb-3">
                                        <span class="input-group-addon"><i
                                                class="glyphicon glyphicon-envelope color-blue"></i></span>
                                        <input id="forgetAnswer" value="<?= $row['phone number'] ?>" name="number"
