...
<body>
  ...
  <div class="main-container">
    ...
    <div class="main">
      ...
      <div class="report-container" id="admins">

        <div class="report-header">
          <h1 class="recent-Articles">Manage Admins</h1>
          <a href="add-admin.php"><button class="view">Add New Admin </button></a>
        </div>
        <table class="table">
          <thead>
            <tr>
                ...
                <form action="" method="post" class="flex-btn">
                  ...
                  <td>
                    ...
                    <button id='rmButton' name="delete" type='submit' class='btn-sm btn-danger'
                      onclick="return confirm('Delete <?= $row['username']; ?>');">Delete</button>
                  </td>
                </form>
              </tr>
              <?php
